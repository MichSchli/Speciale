...
class lstm_layer():
    ...
    def function(self, Vs, W_forget, W_input, W_cell, W_output):
        h0 = np.zeros(self.hidden_neurons)
        c0 = np.zeros(self.hidden_neurons)
...
class fourdirectional_lstm_layer():
    ...
    def __init__(self, hidden_neurons):
        ...
        self.sidewards = bidirectional_lstm_layer(hidden_neurons)
        self.downwards = bidirectional_lstm_layer(hidden_neurons)
    
    def function(self, VM, W_forget, W_input, W_cell, W_output):
        lstm_sidewards, _ = theano.scan(fn=self.sidewards.function,
                                        outputs_info=None,
        ...
        lstm_downwards, _ = theano.scan(fn=self.downwards.function,
                                        outputs_info=None,
